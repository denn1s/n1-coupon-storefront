    ...
    <section id="features" className="border-t border-neutral-200/70 dark:border-neutral-800/70">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-neutral-600 dark:text-neutral-400">Built for teams that demand speed, control, and security.</p>
        </div>
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            <div key={f.title} className="group rounded-xl border border-neutral-200/70 p-6 transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-neutral-800/70">
